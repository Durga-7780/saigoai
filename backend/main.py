...
# Import routers
from app.api.routes import auth, employees, attendance, leaves, chatbot, dashboard, holidays, notifications, announcements, payroll, requests, meals, company, documents

@asynccontextmanager
async def lifespan(app: FastAPI):
    print("🚀 Starting Enterprise Attendance System...")
    
    # Import Document model here to ensure it's available for init_beanie
...
app.include_router(documents.router, prefix="/api/documents", tags=["HR Documents"])
